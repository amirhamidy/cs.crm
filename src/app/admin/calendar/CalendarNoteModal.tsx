...
const EVENT_TYPE_COLOR: Record<string, { bg: string; text: string; dot: string }> = {
    ...
    task: { bg: "bg-blue-400/10", text: "text-gray-800", dot: "bg-blue-600" },
...
export default function CalendarNoteModal({
    ...
    const dayNotes = useMemo(() => {
        ...
        return notes
            ...
            .map((note) => {
                const info = extractNoteInfo(note.description, note.created_at);
                return { ...note, displayDescription: info.cleanDescription };
            });
    }, [notes, selectedKey]);
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <p className={`truncate text-[13.5px] font-semibold ${s.text}`}>
                                                            {ev.title}
                                                        </p>
