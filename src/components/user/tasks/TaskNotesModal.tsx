...
export default function TaskNotesModal({ isOpen, onClose, taskId, taskTitle }: Props) {
                    ...
                    <div className="flex shrink-0 items-center justify-between border-b px-5 py-4" style={{ borderColor: divider }}>
                        <div className="flex min-w-0 items-center gap-3">
                            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-emerald-500/10">
                                <MessageSquareText size={15} className="text-emerald-500" />
                            </div>
                        ...
                        <div className="flex shrink-0 items-center gap-1.5">
                            {!loading && logs.length > 0 && (
                                <div className="flex items-center gap-1 ml-1">
                                    <span className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-[10px] font-bold bg-emerald-500/10 text-emerald-500">
                            ...
                            <div className="flex flex-col gap-3">
                                {logs.map((log) => {
                                    ...
                                    return (
                                        <div
                                            key={log.id}
                                            className="relative rounded-2xl p-3.5 flex flex-col gap-3 overflow-hidden"
                                            style={{
                                                background: card,
                                        ...
                                        >
                                            ...
                                            <div className="flex items-start justify-between gap-3 flex-wrap">
                                                <div className="flex flex-col gap-2">
                                                    <div className="flex items-center gap-1.5 rounded-xl px-2.5 py-1.5 text-[10.5px] font-bold w-fit" style={{ background: actionMeta.bg, color: actionMeta.color }}>
                                                        <ActionIcon size={11} />
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-1.5">
                                                        ...
                                                        {log.step_name && (
                                                            <div className="flex items-center gap-1.5 rounded-xl px-2.5 py-1.5 text-[10px] font-bold bg-white/[0.04] text-gray-500 dark:text-gray-400">
                                                                <Layers3 size={10} />
                                                                <span>مرحله:</span>
                                                                <span className="text-gray-200 dark:text-white">{log.step_name}</span>
                                                            </div>
                                                        )}
                                                    ...
                                                    <div className="flex flex-wrap gap-1.5">
                                                        {log.attachments.map((attachment) => (
                                                            ...
                                                            >
                                                                ...
                                                                <AttachmentUploader
                                                                    employeeId={attachment.uploaded_by}
                                                                    username={attachment.uploaded_by_username}
                                                                />
                                                            </a>
                                                        ))}
                                                    </div>
