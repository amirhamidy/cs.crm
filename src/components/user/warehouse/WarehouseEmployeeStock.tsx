...
import WarehouseEmployeeStockCard from "./WarehouseEmployeeStockCard";
import {
    matchesSearch,
    paginate,
    PAGE_SIZE,
        ...
        <section className="space-y-4">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="relative w-full sm:w-72">
                    ...
                    <input
                        ...
                        className="h-11 w-full rounded-xl border border-white/[0.07] bg-white/[0.03] pr-10 pl-3 text-sm text-white outline-none placeholder:text-white/25 focus:border-blue-400/30"
                    />
                </div>
            </div>
            ...
            {result.items.length ? (
                ...
                <div className="rounded-2xl border border-dashed border-white/[0.08] bg-[#101114] px-6 py-14 text-center">
                    <Boxes className="mx-auto h-9 w-9 text-white/15" />
