...
interface EmployeeCreateTaskRoutineModalProps {
    isOpen: boolean;
    onClose: () => void;
    tasks: InternalTask[];
...
export default function EmployeeCreateTaskRoutineModal({
    isOpen,
    onClose,
    tasks,
    onCreated,
}: EmployeeCreateTaskRoutineModalProps) {
    const { resolvedTheme } = useTheme();
    const isDark = resolvedTheme === "dark";
                    ...
                    >
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-[11px] font-medium text-slate-400">
                                        برای تسک‌های خودت تکرار تعیین کن
                                    </p>
                                </div>
                            </div>
                            <button
                        ...
                        <div className="space-y-4 px-6">
                            <div className="space-y-2">
                                ...
                                {myTasks.length === 0 ? (
                                    <div className="rounded-2xl border border-dashed border-gray-200 px-4 py-5 text-center text-[11.5px] font-semibold text-gray-400 dark:border-white/[0.07]">
                                        تسکی به شما ارجاع نشده است.
                                    </div>
                                ) : (
                                    <TaskPicker
                                        tasks={myTasks}
                        ...
                        <div className="mt-5 flex items-center gap-3 px-6 pb-6">
                            ...
                            <button
                                ...
                                disabled={isSubmitting || myTasks.length === 0}
