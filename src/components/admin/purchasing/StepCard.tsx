    ...
    return (
        ...
        <>
            ...
            <motion.div
                ...
                className="group relative h-full overflow-hidden rounded-[1.8rem] border border-[#DCEAFB] bg-white p-4 shadow-[0_10px_30px_rgba(37,99,235,0.06)] transition-all hover:-translate-y-1 hover:shadow-[0_16px_40px_rgba(37,99,235,0.14)] dark:border-[rgba(96,165,250,0.14)] dark:bg-[#0E1F38]"
