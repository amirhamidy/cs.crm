...
import { Loader2, Power, ShieldCheck, Trash2, X } from "lucide-react";
import axiosInstance from "@/lib/axiosInstance";
import type { AxiosError } from "axios";
import type { ApiQualityControlEmployee } from "@/types/quality_control";

interface QCEmployeeCardProps {
    employee: ApiQualityControlEmployee;
    index: number;
    onUpdated: (employee: ApiQualityControlEmployee) => void;
...
export default function QCEmployeeCard({ employee, index, onUpdated, onDeleted }: QCEmployeeCardProps) {
    ...
    async function handleToggle() {
        ...
        setError("");
        try {
            const { data } = await axiosInstance.patch<ApiQualityControlEmployee>(
                `/quality_control/api/v1/employee/${employee.id}/update/`,
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-[12.5px] leading-6 text-gray-600 dark:text-gray-400">
                                ...
                                از لیست کارمندان کنترل کیفی حذف خواهد شد.
                            </p>
